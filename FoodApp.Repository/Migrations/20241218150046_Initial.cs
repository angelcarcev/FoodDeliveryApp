        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FoodItemDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoodItemInShoppingCarts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FoodItemInShoppingCarts_FoodItems_FoodItemId",
                        column: x => x.FoodItemId,
                        principalTable: "FoodItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FoodItemInShoppingCarts_ShoppingCarts_ShoppingCartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodItemInShoppingCarts_FoodItemId",
                table: "FoodItemInShoppingCarts",
                column: "FoodItemId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodItemInShoppingCarts_ShoppingCartId",
                table: "FoodItemInShoppingCarts",
